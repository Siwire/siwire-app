...
export default function EmptyRepositories() {
    ...
    const emptyRepositoriesInfo = useStyles()
    return <Grid className={emptyRepositoriesInfo.root} item xs={12} container justify="center" alignItems="center">
        <Grid item xs={10} container direction="column" justify="center" alignItems="center">
            ...
            <Typography className={emptyRepositoriesInfo.text}>Repository list is empty</Typography>
        </Grid>
        <Grid item xs={2}>
        </Grid>
    </Grid>
