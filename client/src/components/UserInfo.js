...
export default function UserInfo() {
    ...
    return <Grid item xs={4} container direction="row" justify="center" className={userInfoStyles.root}>
        ...
        <Grid item xs={10}>
            <Grid>
                <Avatar alt="Remy Sharp" src="" className={userInfoStyles.avatar} />
            </Grid>
            <Grid >
                <Typography className={userInfoStyles.name_text} >Name Surname</Typography>
                ...
                <Grid container direction="row" item xs={12}>
                    <Grid container direction="row" item xs={12} md={6}>
                        ...
                        <Typography className={userInfoStyles.info_text}>65k followers</Typography>
                    </Grid>
                    <Grid container direction="row" item xs={12} md={6}>
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <Typography className={userInfoStyles.info_text}>171 following</Typography>
                    </Grid>
                </Grid>
            </Grid>
        </Grid>
